...
router.get("/viewAirlineFlights/:airline_name", async (req,res) => {
...
router.post("/changeFlightStatus/:al_name/:flight_num/:dep_date/:dep_time/:new_status", async (req,res) => {
...
router.post("/addAirplane/:airplane_id/:airline_name/:num_seats/:manufacturing_company/:age", async(req,res) => {
...
router.post("/addAirport/:airport_code/:name/:city/:country/:airport_type", async(req,res) => {
...
router.get("/ratings/:airline_name", async(req,res) => {
...
router.get("/revenueLastYear/:airline_name", async(req,res) => {
...
router.get("/revenueLastSixMonths/:airline_name", async(req,res) => {
...
router.get("/revenueClass/:airline_name", async(req,res) => {
